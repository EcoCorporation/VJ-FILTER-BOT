...
API_ID = int(environ.get('API_ID', '26887168'))
API_HASH = environ.get('API_HASH', 'd9ff30ec9418adb22af18e7beacb92be')
BOT_TOKEN = environ.get('BOT_TOKEN', "7073584365:AAEa0zSEQFdX75bkea8wmHx0Ed_21fK5t1Y")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/df2e2eb5e888871ab5243.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5850899264 959095428').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002025646370') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001800563628')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001800563628')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://qwertyuiop123:Qwerty123@cluster0.c8s4iwx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'ebookguy') # owner username without @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'FMYUtDVpLehpN9gveQA9XpRTRRv1')
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'api.shareus.io')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', 'FMYUtDVpLehpN9gveQA9XpRTRRv1')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/How_To_Open_Linkl')

# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', True))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.shareus.io')
SHORTLINK_API = environ.get('SHORTLINK_API', 'FMYUtDVpLehpN9gveQA9XpRTRRv1')
# https://api.shareus.io/easy_api?key=FMYUtDVpLehpN9gveQA9XpRTRRv1&link=https://shareus.io
# FMYUtDVpLehpN9gveQA9XpRTRRv1 - My api
# hRPS5vvZc0OGOEUQJMJzPiojoVK2 - VJ Api
# Others
MAX_B_TN = environ.get("MAX_B_TN", "5")
PORT = environ.get("PORT", "8080")
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Bibliophiles 📚')
